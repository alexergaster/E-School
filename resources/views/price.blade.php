...
@section('title', 'E-School - Ціни та правила')
@section('description', 'Дізнайтеся про ціни на курси програмування для дітей у Сумах: веб-дизайн, Python, JavaScript, робототехніка та інші напрямки. Ознайомтесь із правилами навчання та умовами запису.')
@section('keywords', 'ціни на курси програмування для дітей Суми, курси програмування для дітей ціни, ціни на навчання веб-дизайну Суми, курси Python для дітей Суми, курси JavaScript для дітей Суми, курси робототехніки для дітей Суми, правила навчання програмуванню, умови запису на курси для дітей, вартість курсів програмування Суми, дитячі курси програмування Суми.')

@section('og_title', 'Курси для дітей у Сумах, від E-School - Ціни та правила')
@section('og_description', 'Дізнайтеся про ціни на курси програмування для дітей у Сумах: веб-дизайн, Python, JavaScript, робототехніка та інші напрямки. Ознайомтесь із правилами навчання та умовами запису.')
            ...
            <div class="questions__items">
                <div class="questions__item">
                    ...
                    <div class="questions__body">
                        Наші обов'язки прописані в <a
                                href="{{ asset('Договор_оферта_на_послуги_навчального_центру_E_school.pdf') }}"
                                target="_blank">публічній аферті</a>. В
